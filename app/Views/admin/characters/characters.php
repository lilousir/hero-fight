                    ...
                    <div class="tab-pane fade show active" id="profil-pane" role="tabpanel" aria-labelledby="profil-tab" tabindex="0">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="id_user" placeholder="id_user" value="<?= isset($characters) ? $characters['id_user'] : ""; ?>" name="id_user">

                            </div>
                            <div class="mb-3">
                                <label for="strength" class="form-label">strength</label>
                                <input type="text" class="form-control" id="strength" placeholder="strength" value="<?= isset($characters) ? $characters['strength'] : "" ?>" name="strength">
                            </div>
                            <div class="mb-3">
                                <label for="constitution" class="form-label">constitution</label>
                                <input type="text" class="form-control" id="constitution" placeholder="constitution" value="<?= isset($characters) ? $characters['constitution'] : "" ?>" name="constitution">
                            </div>
                            <div class="mb-3">
                                <label for="agility" class="form-label">agilité</label>
                                <input type="text" class="form-control" id="agility" placeholder="agility" value="<?= isset($characters) ? $characters['agility'] : "" ?>" name="agility">
                            </div>
                            <div class="mb-3">
                                <label for="experience" class="form-label">expérience</label>
                                <input type="text" class="form-control" id="experience" placeholder="experience" value="<?= isset($characters) ? $characters['experience'] : "" ?>" name="experience">
                            </div>
                            <div class="mb-3">
                                <label for="level" class="form-label">level</label>
                                <input type="text" class="form-control" id="level" placeholder="level" value="<?= isset($characters) ? $characters['level'] : "" ?>" name="level">
                            </div>
                        </div>
                    </div>
                </div>
